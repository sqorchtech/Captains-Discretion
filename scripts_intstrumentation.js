...
const m_and_b = ["Instrumentation toelating1.json", "Instrumentation toelating2.json", "Instrumentation toelating3.json", "Instrumentation toelating4.json", "Instrumentation toelating5.json",]

m_and_b.forEach((filename) => populateQuestions(filename))

function populateQuestions(filename) 
{
    fetch(`jsons/instrumentation/${filename}`)
    .then(res => res.json())
    .then(data => {
