...
const m_and_b = ["ASP toelating1.json", "ASP toelating1a.json", "ASP toelating2.json", "ASP toelating3.json", "ASP toelating4.json", "ASP toelating5.json", "ASP toelating6.json"]

m_and_b.forEach((filename) => populateQuestions(filename))

function populateQuestions(filename) 
{
    fetch(`jsons/asp/${filename}`)
    .then(res => res.json())
    .then(data => {
